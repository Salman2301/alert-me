    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 35, 4, 994);
    			...
    			add_location(input, file$2, 36, 4, 1028);
    			attr_dev(p, "class", "interval svelte-o2qpwt");
    			add_location(p, file$2, 37, 4, 1124);
    			attr_dev(div0, "class", "time svelte-o2qpwt");
    			add_location(div0, file$2, 38, 4, 1173);
    			attr_dev(button, "class", "submitBtn");
    			attr_dev(button, "type", "button");
    			add_location(button, file$2, 42, 4, 1280);
    			attr_dev(div1, "class", "editAlert");
    			add_location(div1, file$2, 33, 2, 963);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(33:0) {#if isAddOrUpdateAlert}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 31, 2, 854);
    			attr_dev(div, "class", "newAlert");
    			add_location(div, file$2, 30, 0, 828);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 47, 2, 995);
    		},
    		m: function mount(target, anchor) {
