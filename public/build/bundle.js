...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 34, 4, 968);
    			...
    			add_location(input, file$2, 35, 4, 1002);
    			attr_dev(p, "class", "interval svelte-o2qpwt");
    			add_location(p, file$2, 36, 4, 1098);
    			attr_dev(div0, "class", "time svelte-o2qpwt");
    			add_location(div0, file$2, 37, 4, 1147);
    			attr_dev(button, "class", "submitBtn");
    			attr_dev(button, "type", "button");
    			add_location(button, file$2, 41, 4, 1254);
    			attr_dev(div1, "class", "editAlert");
    			add_location(div1, file$2, 32, 2, 937);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(32:0) {#if isAddOrUpdateAlert}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 30, 2, 828);
    			attr_dev(div, "class", "newAlert");
    			add_location(div, file$2, 29, 0, 802);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block$1(ctx) {
    	let h1;
    	let t_value = /*$timeString*/ ctx[0].string + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			t = text(t_value);
    			attr_dev(h1, "class", "timer svelte-1m45fl1");
    			add_location(h1, file$3, 46, 2, 968);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$timeString*/ 1 && t_value !== (t_value = /*$timeString*/ ctx[0].string + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$3(ctx) {
    	let if_block_anchor;
    	let if_block = !/*$stop*/ ctx[1] && create_if_block$1(ctx);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	validate_store(nextAlert, "nextAlert");
    	component_subscribe($$self, nextAlert, $$value => $$invalidate(3, $nextAlert = $$value));
    	validate_store(timeString, "timeString");
    	component_subscribe($$self, timeString, $$value => $$invalidate(0, $timeString = $$value));
    	validate_store(alertBox, "alertBox");
    	component_subscribe($$self, alertBox, $$value => $$invalidate(4, $alertBox = $$value));
    	validate_store(currentTime, "currentTime");
    	component_subscribe($$self, currentTime, $$value => $$invalidate(5, $currentTime = $$value));
    	validate_store(stop, "stop");
    	component_subscribe($$self, stop, $$value => $$invalidate(1, $stop = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link, file$6, 13, 1, 333);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ NewAlert, ShowAlert, AlertBox });
    	return [];
    }
